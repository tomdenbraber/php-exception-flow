...
class MutableCombiningCalculatorTest extends \PHPUnit_Framework_TestCase {
	/** @var MutableCombiningCalculator $combining_calculator */
	private $combining_calculator;

	public function setUp() {
		$this->combining_calculator = new MutableCombiningCalculator();
	}
	...
	public function testAddTwoSameTypeCalculatorsRaisesException() {
		$calc_mock_1 = $this->createMock(MutableFlowCalculatorInterface::class);
		$calc_mock_2 = $this->createMock(MutableFlowCalculatorInterface::class);
